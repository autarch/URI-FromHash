...
If you use cpanminus, you can do it without downloading the tarball first:
    ...
    $ cpanm --reinstall --installdeps --with-recommends URI::FromHash
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends URI::FromHash
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/URI-FromHash).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=URI-FromHash)
or [via email](bug-uri-fromhash@rt.cpan.org.
